    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('summary', models.CharField(max_length=255, null=True, blank=True)),
                ('article', models.OneToOneField(to='web.Article')),
            ],
        ),
        migrations.CreateModel(
            name='ArticlePicture',
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('img', models.ImageField(null=True, upload_to=b'uploads', blank=True)),
                ('article', models.OneToOneField(to='web.Article')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_comment', models.ForeignKey(related_name='parentCom', to='web.Comment')),
            ],
        ),
        migrations.CreateModel(
            name='ThumbUp',
